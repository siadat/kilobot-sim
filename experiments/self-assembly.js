...
class GradientAndAssemblyRobot extends Kilobot {
  ...
  */
  ...
  message_rx(message, distance) {
    ...
    this.neighbors_pos_x[index] = message.shapePos && message.shapePos.x;
    this.neighbors_pos_y[index] = message.shapePos && message.shapePos.y;
